Sub Export_ONE_DistributionListToExcel()
    ...
    Else
        ...
        If olkLst.Class = olDistributionList Then
            ...
            strFilename = InputBox("Enter a path and file name for this export", SCRIPT_NAME, Environ("UserProfile") & "\Desktop\" & olkLst.Subject & ".xlsx")
